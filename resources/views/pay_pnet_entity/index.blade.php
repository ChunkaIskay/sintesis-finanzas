...
<div class="container">
	...
	<div class="row">
		<h2> Listado de pagos a entidades - servicios de Pagos Net</h2>
			<div class="row">
					<form action="{{ url('/search-pay-pnet') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
